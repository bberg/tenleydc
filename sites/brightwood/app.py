"""Brightwood Almanac
A Flask application documenting the history of Brightwood, DC"""
...
NAVIGATION = [
    ...
    # Places
    {'slug': 'brightwood', 'title': 'Brightwood', 'icon': 'map-marker-alt', 'group': 'Places'},
    {'slug': 'fort_stevens', 'title': 'Fort Stevens', 'icon': 'flag', 'group': 'Places'},
    {'slug': 'vinegar_hill', 'title': 'Vinegar Hill', 'icon': 'mountain', 'group': 'Places'},
    {'slug': 'walter_reed', 'title': 'Walter Reed', 'icon': 'hospital', 'group': 'Places'},

    # History
    {'slug': 'timeline', 'title': 'Timeline', 'icon': 'clock', 'group': 'History'},
    {'slug': 'civil_war', 'title': 'Civil War', 'icon': 'fort-awesome', 'group': 'History'},
    {'slug': 'african_american', 'title': 'African American Heritage', 'icon': 'users', 'group': 'History'},
    {'slug': 'transportation', 'title': 'Transportation', 'icon': 'train', 'group': 'History'},

    # Community
    {'slug': 'schools', 'title': 'Schools', 'icon': 'school', 'group': 'Community'},
    {'slug': 'churches', 'title': 'Churches', 'icon': 'church', 'group': 'Community'},

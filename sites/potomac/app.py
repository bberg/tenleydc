"""Potomac Almanac
A Flask application documenting the history of Potomac, Maryland"""
...
NAVIGATION = [
    ...
    # Places
    {'slug': 'potomac', 'title': 'Potomac', 'icon': 'building', 'group': 'Places'},
    {'slug': 'potomac-village', 'title': 'Potomac Village', 'icon': 'store-alt', 'group': 'Places'},
    {'slug': 'great-falls', 'title': 'Great Falls', 'icon': 'water', 'group': 'Places'},
    {'slug': 'c-and-o-canal', 'title': 'C&O Canal', 'icon': 'route', 'group': 'Places'},
    ...
    {'slug': 'canal-era', 'title': 'Canal Era', 'icon': 'ship', 'group': 'History'},
    {'slug': 'estates', 'title': 'Historic Estates', 'icon': 'home', 'group': 'History'},

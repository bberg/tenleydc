"""
H Street History Website
A Flask application documenting the history of H Street NE - Black Main Street
"""
...
NAVIGATION = [
    ...
    # Places
    {'slug': 'atlas_district', 'title': 'Atlas District', 'icon': 'theater-masks', 'group': 'Places'},
    {'slug': 'atlas_theater', 'title': 'Atlas Theater', 'icon': 'film', 'group': 'Places'},
    {'slug': 'streetcar', 'title': 'Streetcar Line', 'icon': 'train', 'group': 'Places'},
    {'slug': 'union_station', 'title': 'Near Union Station', 'icon': 'building', 'group': 'Places'},
    ...
    {'slug': 'black_main_street', 'title': 'Black Main Street', 'icon': 'store', 'group': 'History'},
    {'slug': 'the_fire', 'title': '1968 Uprising', 'icon': 'fire', 'group': 'History'},

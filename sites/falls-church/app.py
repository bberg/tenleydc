...
A Flask application documenting the history of Falls Church, Virginia"""
...
NAVIGATION = [
    ...
    # Places
    {'slug': 'downtown', 'title': 'Downtown Falls Church', 'icon': 'building', 'group': 'Places'},
    {'slug': 'state_theater', 'title': 'State Theatre', 'icon': 'masks-theater', 'group': 'Places'},
    {'slug': 'cherry_hill', 'title': 'Cherry Hill Park', 'icon': 'tree', 'group': 'Places'},
    {'slug': 'tinner_hill', 'title': 'Tinner Hill', 'icon': 'fist-raised', 'group': 'Places'},
    ...
    {'slug': 'civil_rights', 'title': 'Civil Rights History', 'icon': 'balance-scale', 'group': 'History'},

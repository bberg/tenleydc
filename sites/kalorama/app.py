"""Kalorama Almanac
A Flask application documenting the history of Kalorama, DC"""
...
NAVIGATION = [
    ...
    # Places
    {'slug': 'kalorama', 'title': 'Kalorama', 'icon': 'map-marker-alt', 'group': 'Places'},
    {'slug': 'sheridan_kalorama', 'title': 'Sheridan-Kalorama', 'icon': 'landmark', 'group': 'Places'},
    {'slug': 'kalorama_triangle', 'title': 'Kalorama Triangle', 'icon': 'shapes', 'group': 'Places'},
    {'slug': 'embassy_row', 'title': 'Embassy Row', 'icon': 'globe', 'group': 'Places'},

    # History
    {'slug': 'timeline', 'title': 'Timeline', 'icon': 'clock', 'group': 'History'},
    {'slug': 'joel_barlow', 'title': 'Joel Barlow Estate', 'icon': 'scroll', 'group': 'History'},
    {'slug': 'presidents', 'title': 'Presidential Residents', 'icon': 'user-tie', 'group': 'History'},
    {'slug': 'architecture', 'title': 'Architecture', 'icon': 'building', 'group': 'History'},

    # Landmarks
    {'slug': 'wilson_house', 'title': 'Woodrow Wilson House', 'icon': 'university', 'group': 'Landmarks'},
    {'slug': 'phillips_collection', 'title': 'Phillips Collection', 'icon': 'palette', 'group': 'Landmarks'},
    {'slug': 'spanish_steps', 'title': 'Spanish Steps', 'icon': 'stairs', 'group': 'Landmarks'},

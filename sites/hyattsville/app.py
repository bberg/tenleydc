"""Hyattsville Almanac
A Flask application documenting the history of Hyattsville, Maryland"""
...
NAVIGATION = [
    ...
    # Places
    {'slug': 'hyattsville', 'title': 'Hyattsville', 'icon': 'building', 'group': 'Places'},
    {'slug': 'arts-district', 'title': 'Arts District', 'icon': 'palette', 'group': 'Places'},
    {'slug': 'historic-district', 'title': 'Historic District', 'icon': 'landmark', 'group': 'Places'},
    {'slug': 'magruder-park', 'title': 'Magruder Park', 'icon': 'tree', 'group': 'Places'},
    ...
    {'slug': 'industrial-era', 'title': 'Industrial Era', 'icon': 'industry', 'group': 'History'},

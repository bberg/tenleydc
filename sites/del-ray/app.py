"""Del Ray Almanac
A Flask application documenting the history of Del Ray, Alexandria"""
...
NAVIGATION = [
    ...
    # Places
    {'slug': 'mount_vernon_ave', 'title': 'Mount Vernon Avenue', 'icon': 'road', 'group': 'Places'},
    {'slug': 'farmers_market', 'title': 'Farmers Market', 'icon': 'store-alt', 'group': 'Places'},
    {'slug': 'avenue_park', 'title': 'The Avenue', 'icon': 'walking', 'group': 'Places'},
    {'slug': 'simpson_park', 'title': 'Simpson Park', 'icon': 'tree', 'group': 'Places'},
    ...
    {'slug': 'streetcar', 'title': 'Streetcar Era', 'icon': 'train-tram', 'group': 'History'},
    {'slug': 'industry', 'title': 'Industrial Heritage', 'icon': 'industry', 'group': 'History'},

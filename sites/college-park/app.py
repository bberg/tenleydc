...
A Flask application documenting the history of College Park, Maryland"""
...
NAVIGATION = [
    ...
    # Places
    {'slug': 'college-park', 'title': 'College Park', 'icon': 'building', 'group': 'Places'},
    {'slug': 'university-of-maryland', 'title': 'University of Maryland', 'icon': 'graduation-cap', 'group': 'Places'},
    {'slug': 'lake-artemesia', 'title': 'Lake Artemesia', 'icon': 'water', 'group': 'Places'},
    {'slug': 'college-park-airport', 'title': 'College Park Airport', 'icon': 'plane', 'group': 'Places'},
    {'slug': 'neighborhoods', 'title': 'Neighborhoods', 'icon': 'map', 'group': 'Places'},

    # History
    {'slug': 'timeline', 'title': 'Timeline', 'icon': 'clock', 'group': 'History'},
    {'slug': 'early-history', 'title': 'Early History', 'icon': 'leaf', 'group': 'History'},
    {'slug': 'transportation', 'title': 'Transportation', 'icon': 'train', 'group': 'History'},
    {'slug': 'aviation', 'title': 'Aviation History', 'icon': 'plane-departure', 'group': 'History'},
...
def business_directory():
    ...
    return render_template('page.html',
                         content='<h1>Local Businesses</h1><p>Business directory coming soon.</p>',
...
def events_page():
    ...
    return render_template('page.html',
                         content='<h1>Events</h1><p>Events calendar coming soon.</p>',
                         title='Events',
                         navigation=NAVIGATION,
                         current_page='events')
...
def interactive_map():
    ...
    return render_template('page.html',
                         content='<h1>Interactive Map</h1><p>Map coming soon.</p>',

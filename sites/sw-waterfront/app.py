"""
Southwest Waterfront History Website
A Flask application documenting the history of the Southwest Waterfront and urban renewal
"""
...
NAVIGATION = [
    ...
    # Places
    {'slug': 'fish_market', 'title': 'Fish Market', 'icon': 'fish', 'group': 'Places'},
    {'slug': 'the_wharf', 'title': 'The Wharf', 'icon': 'water', 'group': 'Places'},
    {'slug': 'wheat_row', 'title': 'Wheat Row', 'icon': 'monument', 'group': 'Places'},
    {'slug': 'waterfront_park', 'title': 'Waterfront Park', 'icon': 'tree', 'group': 'Places'},
    ...
    {'slug': 'urban_renewal', 'title': 'Urban Renewal', 'icon': 'building', 'group': 'History'},
    {'slug': 'the_island', 'title': 'The Island', 'icon': 'water', 'group': 'History'},
...
def load_markdown_content(slug):
    ...
    lines = content.split('\n')
    title = 'Southwest Waterfront History'
    for line in lines:
        if line.startswith('# '):
            title = line[2:].strip()
            break
